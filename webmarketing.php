...
<html lang="en">
   ...
   <body>
                    ...
                    <div class="wrapper">
                        <div class="row">
                            <div class="col-6 hero-title hero-title-2" data-aos="zoom-in" data-aos-duration="3000">
                                <h1 class="exte-title">WEBMARKETING</h1>
                            </div>
                        </div>
                    </div>
                </section>
    ...
    <!--Webmarketing body-->
    <section class="webmarketing-bg-1">
        <div class="wrapper">
            <div class="crc-content-1" data-aos="fade-left" data-aos-duration="3000">
                <h5>Des spécialistes certifiés Google Partner et Analytics à votre disposition</h5>
                <p>Vous voulez améliorer le référencement naturel de votre site web ?  Vous êtes à la recherche d'une agence webmarketing pour y parvenir ?  Faites appel aux équipes de Groupe Externalisation pour vous accompagner !</p>
            ...
            <div class="crc-row">
                ...
                <div class="crc-item webmarketing-item-2" data-aos="fade-left" data-aos-duration="3000">
                    ...
                    <li>De l’hébergement</li>
                    <li>Du référencement de votre site internet</li>
                    <li>De la maintenance du site</li>
                    <li>De vos boites mails</li>
                    <li>Des mises à jour</li>
                </div>
            </div>
        </div>
    </section>
    <section class="webmarketing-bg-2">
