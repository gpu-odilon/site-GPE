...
<body>
    ...
    <header class="header-page-interne">
            <div class="hero-compta-bg">
                ...
                <section id="hero-acceuil" class="hero">
                    <div class="wrapper">
                        <div class="row">
                            <div class="col-6 hero-title hero-title-2" data-aos="fade-down" data-aos-duration="3000">
                                <h1 class="exte-title">COMPTABILITÉ</h1>
                            </div>
                        </div>
                    </div>
                </section>
    ...
    <section class="crc-bg">
        <div class="wrapper">
            ...
            <div class="crc-row">
                <div class="crc-item">
                    <h2 data-aos="fade-right" data-aos-duration="2000">Vous pouvez nous confier vos opérations de</h2>
                </div>
