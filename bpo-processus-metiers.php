        ...
        <div class="wrapper">
            <div class="crc-row">
                ...
                <div class="crc-item bpo-item-2">
                    ...
                    <li>Souscription, modification et réclamation d’abonnés</li>
                    <li>Suivi logistique de bons de commandes</li>
                    <li>Saisie administratif</li>
                    <li>Révision comptable</li>
                    <li>Structuration et intégration de données</li>
                    <li>Traitement de commandes</li>
                    <li>Traitement d’images</li>
                    <li>Veille médiatique et concurrentielle</li>
                    <li>Saisie transcription des piges audiovisuelles<br><span>(réunion, expertises médicales, courriers médicaux, entretien, entrevues, divers comptes-rendus,…)</span> </li>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="wrapper">
            ...
            <div class="crc-row">
                ...
                <div class="crc-item webmarketing-item-2">
                    ...
                    <li>Recouvrement</li>
                    <li>Formulaires de souscription</li>
                    <li>Fidélisation</li>
                </div>
            </div>
        </div>
